...
let todolistButton = document.getElementById ('enter-button');
...
function displayDate(){
    ...
    console.log (date);
    let todoDates = document.getElementById ('date');
    todoDates.innerText = date[1] + ' ' + date[2] + ' ' + date[3];
}
